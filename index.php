	...
	<div class="page-wrap">
		...
		<div id="page">
			<form class="form" onSubmit="return false;">
				...
				<textarea id="source" class="code-input half" placeholder="Your Relational Query Language Here"></textarea>
				<div id="translation" class="code-input half"><span class="placeholder">Generated Structured Query Language</span></div>
				<button id="translate" class="btn-big">TRANSLATE!</button>
